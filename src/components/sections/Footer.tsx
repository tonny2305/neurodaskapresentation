...
const Footer: React.FC = () => {
  return (
    <div className="container-section bg-slate-900 py-8">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-slate-400 mb-4">Sekolah Tinggi Meteorologi Klimatologi dan Geofisika</p>
          ...
          <div className="mt-8 pt-8 border-t border-slate-800 text-center">
            <p className="text-sm text-slate-500">© 2025 NEURODASKA · Empowering Education 2025</p>
          </div>
        </motion.div>
      </div>
    </div>
